    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-6">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportCommissionPerInvoice') ?>">
                    <div class="row g-3">
                        <div class="col-md-4">
                ...
                <div class="row gx-4">
                    <div class="col-md-12 mt-3">
                        <div class="panel-body tab-pane show active" id="hwTherapist">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT SUMMARY COMMISSION PER INVOICE: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                        ...
                        <div class="panel-body tab-pane" id="hwDokter">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT DETAIL COMMISSION PER INVOICE: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                <div class="table-wrapper p-4">
                                    <div class="table-responsive">
