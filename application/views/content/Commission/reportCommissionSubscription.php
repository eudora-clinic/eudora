    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-6">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportCommissionSubscription') ?>">
                    <div class="row g-3">
                        <div class="col-md-4">
                    ...
                    <div class="" id="hwDokter">
                        <div class="card">
                            <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                REPORT SUBSCRIPTION / TOP UP: <?= $period ?>
                            </h3>
                                ...
                                <div class="table-responsive">
                                    <table id="tableDailySales" class="table table-striped table-bordered"
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($listCommissionSubscription as $row) {
                                                ?>
    ...
    $(document).ready(function () {
        $('#tableDailySales').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                var sumCol11Filtered3 = display.map(el => data[el][8]).reduce((a, b) => intVal(a) + intVal(b), 0);
