            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">CREATE USERS COMPANY ACCESS</h5>
                        <button type="button" class="close" data-dismiss="modal">
                            <span>&times;</span>
                        </button>
                    </div>
                    <form id="createForm">
                        <input type="number" hidden id="companyid" name="companyid" required>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-column">
                                <label for="companyid" class="form-label mt-2">Company</label>
                                <select id="companySearch" required data-placeholder="Search Company"></select>
                            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        function fetchData() {
            ...
            $.ajax({
                url: "<?= base_url('ControllerCompany/getListUsersAccessCompany') ?>",
                method: "GET",
                dataType: "json",
        ...
        $('#createForm').submit(function (e) {
            ...
            $.ajax({
                url: '<?= base_url('ControllerCompany/createUserCompanyAccess') ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
        ...
        $("#companySearch").select2({
            width: '100%',
            ajax: {
                url: "ControllerMaster/searchCompany",
                dataType: "json",
                delay: 250,
                data: function (params) {
                    return { search: params.term };
        ...
        $('#createModal').on('hidden.bs.modal', function () {
            ...
            $('#companySearch').val(null).trigger('change');
            $('#userid').val('');
            $('#companyid').val('');
        });
