                                        ...
                                        <table id="tableDailySales" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">LOCATIONACCESSID</th>
                    ...
                    <form id="createForm">
                        ...
                        <div class="modal-body">
                            <div class="form-column">
                                <label for="name" class="form-label mt-2"><strong>USERNAME:</strong></label>
                            ...
                            <div class="form-column">
                                <label for="level" class="form-label mt-2"><strong>LEVEL:</strong></label>
                            ...
                            <div class="form-column">
                                <label for="locationaccsesid"
                                    class="form-label mt-2"><strong>LOCATIONACCESSID:</strong></label>
                                <input type="text" id="locationaccsesid" class="form-control">
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        function fetchData() {
            ...
            $.ajax({
                url: "<?= base_url('ControllerCompany/getListUsers') ?>",
                method: "GET",
                dataType: "json",
        ...
        function openEditModal(id) {
            $.ajax({
                url: '<?= base_url('ControllerCompany/getUserById/') ?>' + id,
                type: 'GET',
                dataType: 'json',
                success: function (response) {
                    if (response.success) {
                        ...
                        $('#locationaccsesid').val(data.locationaccsesid);
        ...
        $('#createForm').submit(function (e) {
            ...
            const formData = {
                ...
                locationaccsesid: $('#locationaccsesid').val(),
                isactive: $('#isactive').val()
            };

            $.ajax({
                url: '<?= base_url('ControllerCompany/createUser') ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                success: function (response) {
