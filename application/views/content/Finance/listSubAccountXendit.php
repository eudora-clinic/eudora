...
<script>
    ...
    $(document).ready(function () {
        ...
        function fetchData() {
            ...
            $.ajax({
                url: "<?= base_url('api/transactions/getListSubAccountXendit') ?>",
                method: "GET",
                dataType: "json",
                success: function (res) {
                    res.data.forEach((row, i) => {
                        dataFormatted.push([
                            i + 1,
                            row.public_profile?.business_name || '',
                            row.email || '',
                            `<div style="display: flex; gap: 4px; justify-content: center;">
                                <a href="<?= base_url('payoutSubAccountXendit/') ?>${row.id}" class="btn-update btn-sm btn-primary"  style="cursor: pointer">Detail</a>
                            </div>`
                        ]);
                    });
