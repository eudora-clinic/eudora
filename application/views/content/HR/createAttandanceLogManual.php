            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">CREATE ATTANDANCE LOG MANUAL</h5>
                    ...
                    <form id="createForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-column">
                                <label for="employee_nip" class="form-label mt-2"><strong>NIP:</strong></label>
                                <input type="text" id="employee_nip" class="form-control" disabled>
                            </div>

                            <div class="form-column">
                                <label for="attandance_date" class="form-label mt-2"><strong>Date:</strong></label>
                                <input type="date" id="attandance_date" class="form-control">
                            </div>

                            <div class="form-column">
                                <label for="check_in_time" class="form-label mt-2"><strong>Check In:</strong></label>
                                <input type="time" id="check_in_time" class="form-control">
                            </div>

                            <div class="form-column">
                                <label for="check_out_time" class="form-label mt-2"><strong>Check Out:</strong></label>
...
<script>
    $(document).ready(function () {
        ...
        function fetchData() {
            ...
            $.ajax({
                url: "<?= base_url('ControllerHr/getAttandanceLogManual') ?>",
                method: "GET",
                dataType: "json",
        ...
        function openEditModal(id) {
            $.ajax({
                url: '<?= base_url('ControllerHr/getAttandanceLogManualById/') ?>' + id,
                type: 'GET',
                dataType: 'json',
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        let option = new Option(data.employeename + " - " + data.employee_nip, true, true);
                        ...
                        $('#attandance_date').val(data.attandance_date);
        ...
        $('#createForm').submit(function (e) {
            ...
            const formData = {
                ...
                employee_nip: $('#employee_nip').val(),
                attandance_date: $('#attandance_date').val(),
            ...
            $.ajax({
                url: '<?= base_url('ControllerHr/createAttandanceLogManual') ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                success: function (response) {
        ...
        $("#employeeSearch").select2({
            width: '100%',
            ajax: {
                url: "ControllerMaster/searchEmployee",
                dataType: "json",
                delay: 250,
