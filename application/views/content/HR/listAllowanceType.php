                                        ...
                                        <table id="tableDailySales" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">ALLOWANCE NAME</th>
                    ...
                    <form id="createForm">
                        <div class="modal-body">
                            <div class="form-column">
                                <label for="allowance_name" class="form-label mt-2"><strong>ALLOWANCE NAME:</strong></label>
                ...
                <div class="modal-content">
                    ...
                    <form id="updateForm">
                        <div class="modal-body">
                            ...
                            <div class="form-column">
                                <label for="allowance_nameUpdate" class="form-label mt-2"><strong>ALLOWANCE NAME:</strong></label>
                                <input type="text" id="allowance_nameUpdate" class="form-control">
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        function fetchData() {
            ...
            $.ajax({
                url: "<?= base_url('ControllerHr/getListAllowanceType') ?>",
                method: "GET",
                dataType: "json",
        ...
        function openEditModal(id) {
            $.ajax({
                url: '<?= base_url('ControllerHr/getDetailAllowanceType/') ?>' + id,
                type: 'GET',
                dataType: 'json',
                success: function (response) {
                    if (response.success) {
                        ...
                        $('#allowance_nameUpdate').val(data.allowance_name);
        ...
        $('#createForm').submit(function (e) {
            ...
            $.ajax({
                url: '<?= base_url('ControllerHr/createAllowanceType') ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                success: function (response) {
        ...
        $('#updateForm').submit(function (e) {
            ...
            const formData = {
                id: $('#updateId').val(),
                allowance_name: $('#allowance_nameUpdate').val(),
                description: $('#descriptionUpdate').val(),
                isactive: $('#isactiveUpdate').val(),
            };
            $.ajax({
                url: '<?= base_url('ControllerHr/updateAllowanceType') ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                success: function (response) {
