    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-6">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportLastCustomerSpendingAndPrepaidLeft') ?>">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                <select id="locationIdSearch" name="locationIdSearch"
                                    class="form-control text-uppercase " required="true" aria-required="true">
                    ...
                    <div class="" id="hwDokter">
                        <div class="card">
                            <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                REPORT CUSTOMER INVOICE LAST 2 YEAR AND PREPAID LEFT
                            </h3>
                                    ...
                                    <table id="tableDailySales" class="table table-striped table-bordered"
                                        ...
                                        <thead class="bg-thead">
                                            <tr>
                                                ...
                                                <th style="text-align: center;">LAST INVOICE</th>
                                                <th style="text-align: center;">PREPAID LEFT</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($listCustomerLastSpending as $row) {
                                                ?>
                                                <tr role="" style="font-weight: 400;">
                                                    ...
                                                    <td style="text-align: center;"><?= $row['LASTINVOICEDATE'] ?></td>
                                                    <td style="text-align: center;"><?= $row['TOTALPREPAIDLEFT'] ?></td>
                                                    <td style="text-align: center;"><a target="_blank" class="btn btn-primary btn-sm" href="https://sys.eudoraclinic.com:84/app/detailPrepaidInvoiceCustomer/<?= $row['CUSTOMERID'] ?>">DETAIL</a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
