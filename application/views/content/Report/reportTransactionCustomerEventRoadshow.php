        ...
        <div class="mycontaine">
            <div class="card p-2 col-md-9">
                <form id="form-cari-invoice" method="post"
                    action="<?= base_url('reportTransactionCustomerEventRoadshow') ?>">
                        ...
                        <div>
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT TRANSACTION GUEST BY DATE REGISTER: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                        ...
                                        <table id="tableSummary" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">LOCATION REGISTER</th>
                                                    <th style="text-align: center;">TOTAL TRANSACTION</th>
                                                    <th style="text-align: center;">TOTAL FIRST DAY TRANSACTION</th>
                                                </tr>
                                            </thead>
                                            <tfoot>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportTransactionCustomerEventRoadshow as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['AMOUNTOMSET'], 0, ',', ',') ?>
                                                        </td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['AMOUNTFIRSTINVOICE'], 0, ',', ',') ?>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
