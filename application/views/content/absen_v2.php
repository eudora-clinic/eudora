...
// $period = $db_oriskin->query("select period from msabsen group by period order by period desc")->result_array();
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3-mobile">
                            <div class="form-group">
                                <select name="period_awal" class="form-control" required>
                        ...
                        <div class="col-md-4 mb-3-mobile">
                            <div class="form-group">
                                <select name="period_akhir" class="form-control" required>
                        ...
                        <div class="col-md-4 mt-2-mobile">
                            <div class="form-group">
    ...
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                // echo 'ini locationid: '.$locationid;
...
<!-- EDIT -->
<?php foreach ($data_absen as $row) { ?>
    <div class="modal fade" id="edit<?= $row['IDABSEN'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="form-cari-invoice" data-spy="scroll" method="post" action="<?= base_url('edit-employee-absen') ?>">
                    <div class="modal-body">
                        ...
                        <input type="number" name="jobid" value="<?= $row['JOBID'] ?>" class="form-control jobid_edit" readonly>
                            ...
                            <?php for ($i = 1; $i <= $tanggal_terakhir; $i++) { ?>
                                ...
                                <script>
                                    ...
                                    function autofill_timestart_edit<?= $row['EMPLOYEEID'] ?>() {
                                        ...
                                        console.log('get_employeeid_edit: ', get_employeeid_edit<?= $row['EMPLOYEEID'] ?>);
                                    }
