                ...
                <table id="tbl-items" class="table table-bordered items-list">
                    <thead class="bg-thead">
                        <tr>
                            ...
                            <th style="font-size: 12px; text-align: center;">TARGET UNIT</th>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            newTable.querySelector(".add-items").addEventListener("click", function() {
                ...
                const selectElement = $(lastItems).find(".locationid");
        ...
        function addPackage() {
            ...
            document.querySelectorAll('.items-list tbody tr').forEach(method => {
                ...
                if (!locationid || !target || !period || !targetunit) {
            ...
            $.ajax({
                url: "<?= base_url() . 'App/addTargetOutlet' ?>",
                type: 'POST',
