    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-6">
                <form id="form-cari-invoice" method="post" action="<?= base_url('balancePrepaidWess') ?>">
                                        ...
                                        <table id="tableDailySales" class="table table-striped table-bordered" style="width:100%">
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">PURCHASEDATE</th>
                                                    <th style="text-align: center;">INVOICENO</th>
                                                    <th style="text-align: center;">ITEMCODE</th>
                                                    <th style="text-align: center;">ITEM</th>
                                                    <th style="text-align: center;">USED</th>
                                                    <th style="text-align: center;">BALANCE</th>
                                                    <th style="text-align: center;">QTyTOTAL</th>
                                                    <th style="text-align: center;">AMOUNT</th>
                                                    <th style="text-align: center;">PURCHASEAT</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                ...
                                                ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;"><?= $row['purchasedate'] ?></td>
                                                        ...
                                                        <td style="text-align: center;"><?= $row['used'] ?></td>
                                                        <td style="text-align: center;"><?= $row['balance'] ?></td>
                                                        <td style="text-align: center;"><?= $row['qty'] ?></td>
                                                        <td style="text-align: center;"><?= $row['total'] ?></td>
                                                        <td style="text-align: center;"><?= $row['purchaseat'] ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
