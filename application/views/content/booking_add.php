    	...
    	<div class="col-md-12">
      		<div class="card">
        		<div class="card-header card-header-primary">
            		<h4 class="card-title">Input Booking</h4>
        		</div>
				<div class="card-body">
					<form id="form-add-employee" method="post" action="<?= base_url().'App/insertMsemployee' ?>">
						<div class="row">
							<label class="col-md-2 col-form-label"><b>Date Booking</b></label>
							<div class="col-md-6">
						...
						<div class="row">
							<label class="col-md-2 col-form-label"><b>Customer ID</b></label>
							<div class="col-md-6">
								<div class="form-group bmd-form-group">
						...
						<div class="row">
							<label class="col-md-2 col-form-label"><b>Start Treatment</b></label>
							<div class="col-md-2">
								<div class="form-group bmd-form-group">
									<input type="text" id="startTreatment" name="cellphonenumber" class="form-control timepicker" required="true" aria-required="true">
								</div>
							</div>
							<label class="col-form-label"><b>End Treatment</b></label>
							<div class="col-md-2">
								<div class="form-group bmd-form-group">
									<input type="text" id="endTreatment" name="cellphonenumber" class="form-control timepicker5" required="true" aria-required="true">
								</div>
							</div>
						...
						<div class="row">
							<label class="col-md-2 col-form-label"><b>Treatment ID</b></label>
							<div class="col-md-2">
								<div class="form-group bmd-form-group">
							...
							<label class="col-md-2 col-form-label"><b>Guest Name</b></label>
							<div class="col-md-2">
								<div class="form-group bmd-form-group">
...
<script>
	$(function () {
		var startTreatment = new TimePicker('#startTreatment', {
			theme: 'purple',
			lang: 'en',
		});
		startTreatment.on('change', function(evt) {
			var value = ((evt.hour).padStart(2, '0') || '00') + ':' + (evt.minute || '00');
			evt.element.value = value;
		});
		var endTreatment = new TimePicker('#endTreatment', {
			theme: 'purple',
			lang: 'en',
		});
		endTreatment.on('change', function(evt) {
			var value = ((evt.hour).padStart(2, '0') || '00') + ':' + (evt.minute || '00');
			evt.element.value = value;
		});
	});
