    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('App/search_data_booking_dokterDev') ?>" method="post">
                        <div class="row">
                                                                ...
                                                                if (count($membership_treatment) > 0) {
                                                                    foreach ($membership_treatment as $mt) {
                                                                        ...
                                                                        echo '<tr>
                                                                                ...
                                                                                <td class="text-center">'.$row['IDFROMDB'].'</td>
        ...
        <!-- Modal Add Doing Treatment -->
            <div class="modal fade modal-transparent modal-fullscreen" id="modalNewDoingTreatment" tabindex="-1" role="dialog" aria-labelledby="modalNewDoingTreatment">
                <div class="modal-dialog modal-lg" role="dialog">
                    <div class="modal-content">
                        <form class="form-horizontal" action="<?= base_url('savedoingtreatmentDev') ?>" role="form" method="post">
