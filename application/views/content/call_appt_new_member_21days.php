...
$db_oriskin = $this->load->database('oriskin', true);
$query = $db_oriskin->query("EXEC [spReportCallApptDetailNewMember]  '" . $lastmonth . "','" . $locationid . "' ");

if (!$query) {
    $error = $db_oriskin->error(); // Mendapatkan pesan kesalahan
		...
		<div class="col-md-12">
			...
			<div class="card">
				<div class="card-header card-header-primary">
					<h4 class="card-title">CALL DATA NEW MEMBER 21 DAYS</h4>
				</div>
				<div class="card-body">
