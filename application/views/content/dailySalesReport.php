...
<head>
    ...
    $summaryPayment = $db_oriskin->query("Exec spClinicSummaryByPaymentPerDay '" . $dateSearch . "', '" . $locationId . "' ")->result_array();
    ?>
</head>
                                                ...
                                                ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;">
                                                            <?= $row['PRODUCTNAME'] ?><?= !empty($row['REMARKS']) ? ' : ' . $row['REMARKS'] : '' ?>
                                                        </td>

                                                        <td style="text-align: center;"><?= $row['ITEMCODE'] ?></td>

                                                        <td style="text-align: center;"><?= number_format($row['PRICE'], 0, '.', ',') ?></td>
                                                        <td style="text-align: right;"><?= number_format($row['TOTALDISCOUNT'], 0, '.', ',') ?></td>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr role="" style="font-weight: 400;">
                                                            ...
                                                            <td style="text-align: center;"><?= $row['INSTALLMENTNAME'] ?></td>
                                                            <td style="text-align: center;"><?= number_format($row['AMOUNT'], 0, '.', ',') ?></td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
                        ...
                        <div class="panel-body tab-pane" id="summaryPayment">
                            ...
                            <div class="card">
                                <h3 class="card-header card-header-info" style=" font-weight: bold; color: #666666;">
                                    ...
                                    <div class="table-wrapper p-4">
                                        <div class="table-responsive">
                                            <table id="tableSummaryPayment" class="table table-striped table-bordered" style="width:100%">
                                                <thead class="bg-thead">
                                                    <tr>
                                                        <th style="text-align: center;">NO</th>
                                                        <th style="text-align: center;">PAYMENT</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr role="" style="font-weight: 400;">
                                                            ...
                                                            <td style="text-align: center;"><?= $row['INSTALLMENTNAME'] ?></td>
                                                            <td style="text-align: center;"><?= number_format($row['AMOUNT'], 0, '.', ',') ?></td>
                                                            <td style="text-align: center;"><?= number_format($row['AMOUNTSETTLEMENT'], 0, '.', ',') ?></td>
                                                            <td style="text-align: center;"><?= number_format($row['AMOUNTBALANCE'], 0, '.', ',') ?></td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
