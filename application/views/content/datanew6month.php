		...
		<div class="col-md-12">
			...
			<div class="card">
				<div class="card-header card-header-primary">
					<h4 class="card-title">Data New 6 Month</h4>
				</div>
				<div class="card-body">
					<?php
					# display error
					...
					$db_oriskin = $this->load->database('oriskin', true);
					# query
					$query = $db_oriskin->query("EXEC spReportCallNewLc6MonthFrClinic '" . $currentMonth . "','" . $locationid . "' ");
						...
						<table id="example" class="table text-center table-bordered" style="width:100%">
							<thead class="thead-danger">
								<tr role="">
									...
									<th width="150px" class="first-col sticky-col text-center">Name</th>
	...
	$(document).ready(function() {
		...
		$(".btn-save").each(function(index) {
			$(this).on("click", function() {
				...
				$.post("<?= base_url('save-note-followup-doing') ?>", {
					customerid: id,
					note: note,
					period: period,
