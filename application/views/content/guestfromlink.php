										...
										<table id="tableDailySales" class="table table-striped table-bordered" style="width:100%">
											<thead class="bg-thead">
												<tr>
													...
													<th style="text-align: center;">CONSULTANT LOCATION</th>
													<th style="text-align: center;">REFFERAL NAME</th>
													<th style="text-align: center;">ID REFFERAL</th>
											...
											<tbody>
												<?php
												$no = 1;
												foreach ($listGuestFromLinkRefferal as $row) {
												...
												?>
													<tr role="" style="font-weight: 400;">
														...
														<td style="text-align: center;"><?= $row['EMPLOYEELOCATIONNAME'] ?></td>
														<td style="text-align: center;"><?= $row['REFFERALNAME'] ?></td>
														...
														<td style="text-align: center;">
															<a href="https://wa.me/<?= $new_number ?>" target="_blank">
																<i class="fa-brands fa-whatsapp fa-fade fa-3xl"></i>
															</a>
														</td>
													</tr>
												<?php } ?>
