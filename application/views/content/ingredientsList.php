                        ...
                        <div class=" " id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info d-flex justify-content-between align-items-center"
                                    ...
                                    INGREDIENTS LIST
                                    <a href="https://sys.eudoraclinic.com:84/app/addIngredients"
                                ...
                                <div class="row p-4 filter-container">
                                    <div class="form-group" style="display: flex; flex-direction: column;">
                                        <label for="filterSection" style="margin-bottom: 4px;">CATEGORY:</label>
                                        <select id="filterSection" class="form-control">
                                            <option value="">ALL</option>
                                            <option value="ED-">DOKTER</option>
                                            <option value="ES-">SALON</option>
                                            <option value="ET-">TOOLS</option>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <table id="tableDailySales" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">QTY TO UOM</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($ingredientsList as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;"><?= $row['QTYTOUOM'] ?></td>
                                                        <td style="text-align: center;">
...
<script>
    ...
    //     let base_url = "<?= base_url('detailIngredients'); ?>";
    ...
    function goToDetail(id) {
        ...
        // buka di tab baru
        window.open(base_url + "?" + queryParams, '_blank');
    }
