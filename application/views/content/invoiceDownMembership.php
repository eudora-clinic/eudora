            ...
            <div class="row g-3" style="display: flex; align-items: center;">
                <div class="col-md-9">
                    <div class="form-group">
                        <input type="text" id="nodownpayment" name="nodownpayment" class="form-control" required="true" aria-required="true" placeholder="Masukkan Invoice DP Package" value="<?= (isset($_GET['nodownpayment']) ? $_GET['nodownpayment'] : '') ?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <h5 class="card-header card-header-info" style=" font-weight: bold; color: #666666; font-size: 14px !important; text-transform: uppercase;">Edit Data Invoice Down Payment Membership</h5>
                </div>
                <div class="card-body">
                    <div id="result" style="display: <?= (isset($_GET['submit']) ? 'block;' : 'none;') ?>">
                        ...
                        if (isset($_GET['submit'])) {
                            ...
                            # query
                            $query = $db_oriskin->query("SELECT a.locationsalesid as LOCATIONID,  a.id, a.downpaymentno as INVOICENO, a.downpaymentdate as INVOICEDATE, 
                                                                a.status as STATUS, e.id as CONSULTANTID, e.name as CNAME,  
                                                                b.id as DTLID, b.totalamount as TOTAL, b.totalmonth as QTY
