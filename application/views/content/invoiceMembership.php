                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <input type="text" id="no-invoice" name="no-invoice" class="form-control" required="true"
                            aria-required="true" placeholder="INVOICE MEMBERSHIP">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="updateForm">
                        ...
                        <input type="number" hidden id="type" name="type" value="2">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#itemname").select2({
            width: '100%',
            ajax: {
                url: "App/searchPackage", // Panggil controller Customer
                dataType: "json",
                delay: 250,
                data: function (params) {
                    return {
    ...
    function updateInvoice() {
        ...
        let hasError = false;
        if (!invoicehdrid || !customerid || !invoiceno || !salesid || !itempurchaseid || !amount 
            ||!qty || !invoicedate
        ) {
            alert('Terjadi kesalahan silahkan di refresh atau login ulang!');
            return false;
