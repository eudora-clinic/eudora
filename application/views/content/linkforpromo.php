    	...
    	<div class="col-md-12">
      		...
      		<div class="card">
        		<div class="card-header card-header-primary">
            		<h4 class="card-title">Data Link For Promo Oriskin</h4>
        		</div>
				<div class="card-body">
						<?php
							// setting unlimited utk php
							...
							# tidak dibuat di model
								...
								# query
								$sql = "select  * from mscustomer where locationid = '".$name."' ORDER BY updatedate DESC";
								//echo $sql; die();
									...
									<tbody>
										<?php $no=1; foreach($header as $row){ ?>
											<tr role="">
												...
												<td>
													<input type="text" class="hidden-input" id="copyLinkRef<?= $row['id'] ?>" value="https://app.oriskin.co.id:84/merdekaperawatan/referal-code/<?= $row['id'] ?>">
													<button class="btn btn-primary" onclick="copyToClipboard<?= $row['id'] ?>()">Get Link Promo</button>
												</td>
											</tr>
										<?php } ?>
									</tbody>
