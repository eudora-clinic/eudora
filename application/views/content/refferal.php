	...
	<div>
		<div class="mycontaine">
			<div class="card p-2 col-md-6">
				<form id="form-cari-invoice" method="post" action="<?= base_url('refferal') ?>">
					<div class="row g-3" style="display: flex; align-items: center;">
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" class="form-control text-uppercase" name="search" id="search" placeholder="Name / HP / SSID / Customer Code / Member Code" required>
							</div>
						</div>
										...
										<table id="tableDailySales" class="table table-striped table-bordered" style="width:100%">
											<thead class="bg-thead">
												<tr>
													...
													<th style="text-align: center;">LINK DASHBBOARD</th>
												...
												?>
													<tr role="" style="font-weight: 400;">
														...
														<td style="text-align: center;">
															<button class="copy-btn-refferal" data-text="https://sys.eudoraclinic.com:84/registration/referal-code/<?= $row['id'] ?>">
																<i class="fas fa-copy"></i>
															</button>
														</td>
														<td style="text-align: center;">
															<button class="copy-btn-refferal" data-text="https://sys.eudoraclinic.com:84/customer/dashboard/<?= $row['id'] ?>">
																<i class="fas fa-copy"></i>
															</button>
														</td>
														<td style="text-align: center;">
															<a class="btn btn-primary btn-sm" href="https://sys.eudoraclinic.com:84/historymember/erm_ref/<?= $row['id'] ?>">DETAIL</a>
														</td>
													</tr>
												<?php } ?>
											</tbody>
