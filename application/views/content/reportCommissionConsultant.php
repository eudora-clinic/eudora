    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-6">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportCommissionConsultant') ?>">
            ...
            <div>
                <ul class="nav nav-tabs active mt-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#detailUnit">DETAIL UNIT/NEW MEMBER</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-content">
                <div class="row gx-4">
                    <div class="col-md-12 mt-3">
                                        ...
                                        <table id="tableDailySales" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">PRODUCT(ALL)</th>
                                                    <th style="text-align: center;">TREATMENT</th>
                                                    <th style="text-align: center;">PACKAGE</th>
                                                    <th style="text-align: center;">TOTAL OMSET</th>
                                                    <th style="text-align: center;">TARGETOMSET</th>
                                                    <th style="text-align: center;">TARGET UNIT</th>
                                                    <th style="text-align: center;">TOTAL UNIT</th>
                                                    <th style="text-align: center;">COMMISSION</th>
                                                    <th style="text-align: center;">BONUS</th>
                                                    <th style="text-align: center;">COMMISSION NEW MEMBER</th>
                                                    <!-- <th style="text-align: center;">PRODUCT (RACIKAN)</th>
                                                    <th style="text-align: center;">PRODUCT (RETAIL)</th> -->
                                                    <th style="text-align: center;">QTY RETAIL</th>
                                                    <th style="text-align: center;">COMMISSION RETAIL</th>
                                                ...
                                                ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;">
                                                            <?= number_format($row['PRODUK'], 0, '.', ',') ?>
                                                        </td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['TREATMENT'], 0, '.', ',') ?>
                                                        </td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['PACKAGE'], 0, '.', ',') ?>
                                                        </td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['TOTAL'], 0, '.', ',') ?>
                                                        </td>
                                                        <td style="text-align: center;">
                                                            <?= number_format($row['TARGETOMSET'], 0, '.', ',') ?>
                                                        </td>
                                                        <td style="text-align: centee;"><?= $row['TARGETUNIT'] ?></td>
                                                        <td style="text-align: centee;"><?= $row['TOTALUNIT'] ?></td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['COMMISSION'], 0, '.', ',') ?>
                                                        </td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['EXTRABONUS'], 0, '.', ',') ?>
                                                        </td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['COMMISSIONUNIT'], 0, '.', ',') ?>
                                                        </td>
                                                        <!-- <td style="text-align: right;">
                                                            <?= number_format($row['PRODUKRACIKAN'], 0, '.', ',') ?>
                                                        </td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['PRODUKRETAIL'], 0, '.', ',') ?>
                                                        </td> -->
                                                        <td style="text-align: centee;"><?= $row['TOTALQTYRETAIL'] ?></td>

                                                        <td style="text-align: right;">
                                                            <?= number_format($row['COMMISSIONPRODUCT'], 0, '.', ',') ?>
                                                        </td>

                                                        <td style="text-align: right;">
                                                            <?= number_format($row['TOTALCOMMISSION'], 0, '.', ',') ?>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                                        ...
                                                        <tr role="" style="font-weight: 400;">
                                                            ...
                                                            <?php if ($level == 4): ?>
                                                                <td style="text-align: center;">
                                                                    ...
                                                                    ?>
                                                                    <a href="<?= $url ?>?invoice=<?= urlencode($invoiceNo) ?>" target="_blank">
                                                                        <?= $invoiceNo ?>
                                                                    </a>
                                                                </td>
                                                            <?php endif; ?>
                        ...
                        <div class="panel-body tab-pane" id="detailUnit">
                            <div class="card">
                                <h3 class="card-header card-header-info" style=" font-weight: bold; color: #666666;">
                                    DETAIL UNIT / NEW MEMBER: <?= $period ?>
                                    </h4>

                                    <div class="row p-4 filter-container">
                                        <?php if ($level != 1) { ?>
                                            <label for="filterBranch3">BRANCH:</label>
                                            <select id="filterBranch3" multiple="multiple">
                                                <option value="">ALL</option>
                                                <?php foreach ($locationList as $location) { ?>
                                                    <option value="<?= htmlspecialchars($location['name']) ?>">
                                                        <?= htmlspecialchars($location['name']) ?>
                                        ...
                                        <label for="filterStaff3">STAFF:</label>
                                        <select id="filterStaff3" multiple="multiple">
                                            <option value="">ALL</option>
                                            <?php foreach ($staffSalesInvoice as $staff) { ?>
                                                <option value="<?= htmlspecialchars($staff['EMPLOYEENAME']) ?>">
                                                    <?= htmlspecialchars($staff['EMPLOYEENAME']) ?>
                                    ...
                                    <div class="table-wrapper p-4">
                                        <div class="table-responsive">
                                            <table id="tableDetailUnit" class="table table-striped table-bordered"
                                                style="width:100%">
                                                <thead class="bg-thead">
                                                    <tr>
                                                        <th style="text-align: center;">NO</th>
                                                ...
                                                <tbody>
                                                    <?php
                                                    $no = 1;
                                                    foreach ($detailUnitNewMember as $row) {
                                                    ?>
                                                        <tr role="" style="font-weight: 400;">
                                                            <td style="text-align: center;"><?= $no++ ?></td>
                                                            <td style="text-align: center;"><?= $row['LOCATIONNAME'] ?></td>
                                                            <td style="text-align: centee;"><?= $row['EMPLOYEENAME'] ?></td>
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#tableDailySales').DataTable({
            ...
            "footerCallback": function(row, data, start, end, display) {
                ...
                var sumCol11FilteredA = display.map(el => data[el][7]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11FilteredB = display.map(el => data[el][8]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11FilteredC = display.map(el => data[el][9]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11FilteredD = display.map(el => data[el][10]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11FilteredE = display.map(el => data[el][11]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11FilteredF = display.map(el => data[el][12]).reduce((a, b) => intVal(a) + intVal(b), 0);


                var sumCol11FilteredB1 = display.map(el => data[el][13]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11FilteredC2 = display.map(el => data[el][14]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11FilteredD3 = display.map(el => data[el][15]).reduce((a, b) => intVal(a) + intVal(b), 0);
                // var sumCol11FilteredE4 = display.map(el => data[el][16]).reduce((a, b) => intVal(a) + intVal(b), 0);
                // var sumCol11FilteredF5 = display.map(el => data[el][17]).reduce((a, b) => intVal(a) + intVal(b), 0);
                ...
                $(api.column(7).footer()).html(
                    numberFormat(sumCol11FilteredA, 0)
                );
                $(api.column(8).footer()).html(
                    numberFormat(sumCol11FilteredB, 0)
                );
                $(api.column(9).footer()).html(
                    numberFormat(sumCol11FilteredC, 0)
                );
                $(api.column(10).footer()).html(
                    numberFormat(sumCol11FilteredD, 0)
                );
                $(api.column(11).footer()).html(
                    numberFormat(sumCol11FilteredE, 0)
                );
                $(api.column(12).footer()).html(
                    numberFormat(sumCol11FilteredF, 0)
                );


                $(api.column(13).footer()).html(
                    numberFormat(sumCol11FilteredB1, 0)
                );
                $(api.column(14).footer()).html(
                    numberFormat(sumCol11FilteredC2, 0)
                );
                $(api.column(15).footer()).html(
                    numberFormat(sumCol11FilteredD3, 0)
                );
                // $(api.column(16).footer()).html(
                //     numberFormat(sumCol11FilteredE4, 0)
                // );
                // $(api.column(17).footer()).html(
                //     numberFormat(sumCol11FilteredF5, 0)
                // );
        ...
        var table5 = $('#tableDetailUnit').DataTable({
            "pageLength": 10,
            "lengthMenu": [5, 10, 15, 20, 25],
            select: true,
            'bAutoWidth': false,
            "footerCallback": function(row, data, start, end, display) {
                ...
                var sumCol11Filtered16 = display.map(el => data[el][4]).reduce((a, b) => intVal(a) + intVal(b), 0);
        ...
        $('#filterBranch3, #filterStaff3').select2({
            width: '200px'
        });
        $('#filterStaff3').on('change', function() {
            var value4 = $(this).val().join('|');
            table5.column(2).search(value4, true, false).draw(); // Kolom ke-8 (Branch)
        });

        $('#filterBranch3').on('change', function() {
            var value4 = $(this).val().join('|');
            table5.column(1).search(value4, true, false).draw(); // Kolom ke-8 (Branch)
        });
    ...
    //  $('#tableDetailUnit').removeClass('display').addClass(
    // 'table table-striped table-hover table-compact');
</script>
