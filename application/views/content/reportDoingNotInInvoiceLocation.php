...
<head>
    ...
    <title>Eudora - Report Doing Not In Invoice Location</title>
    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-9">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportDoingNotInInvoiceLocation') ?>">
                        ...
                        <div class=" " id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT DOING NOT IN INVOICE LOCATION: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                        ...
                                        <table id="tableDailySales" class="table table-striped table-bordered" style="width:100%">
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">LOCATION DOING</th>
                                                    ...
                                                    <th style="text-align: center;">INVOICE LOCATION</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($listDoingNotInInvoiceLocation as $row) {
                                                ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;"><?= $row['DOINGBY'] ?>, <?= $row['ASSISTBY'] ?></td>
