...
<body>
    <div>
        ...
        <form id="form-cari-invoice" method="post" action="<?= base_url("reportGuestAffiliate/$empId") ?>">
                        ...
                        <div class=" " id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info" style=" font-weight: bold; color: #666666;">
                                    REPORT GUEST AFFILIATE: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                <div class="table-wrapper p-4">
                                    <div class="table-responsive">
                                        <table id="tableDailySales" class="table table-striped table-bordered" style="width:100%">
                                            ...
                                            <?php
                                                $no = 1;
                                                foreach ($reportGuestAffiliate as $row) {
                                                ?>
