    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-9">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportGuestCustomerServiceOnline') ?>">
                ...
                <div class="row gx-4">
                    <div class="col-md-12 mt-3">
                        <div class="panel-body tab-pane show active" id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT SUMMARY GUEST SHOW ADMIN: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                    ...
                                    <div class="table-responsive">
                                        <table id="tableSummary" class="table table-striped table-bordered"
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportGuestOnlineAdminCsoSummary as $row) {
                                                    ?>
                        ...
                        <div class="panel-body tab-pane" id="hwDokter">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT GUEST SHOW ADMIN: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>

                                <div class="row p-4 filter-container">
                                    <label for="filterAdmin">Filter Admin:</label>
                                    <select id="filterAdmin" multiple="multiple">
                                        <option value="">Semua Admin</option>
                                        <option value="REZA">REZA</option>
                                        <option value="NAJMIA">NAJMIA</option>
                                        <option value="CADELIA">CADELIA</option>
                                        ...
                                        <table id="tableDailySales" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">F STATUS</th>
                                                    <th style="text-align: center;">BROUGHT BY</th>
                                                </tr>
                                            </thead>
                                            <tfoot>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportGuestOnlineAdminCso as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        <td style="text-align: center;"><?= $no++ ?></td>
                                                        ...
                                                        <td style="text-align: center;"><?= $row['LEVELNAME'] ?></td>
                                                        <td style="text-align: center;"><?= $row['BROUGHTBY'] ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
