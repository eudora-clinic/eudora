    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-9">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportGuestEvent') ?>">
            ...
            <div>
                <ul class="nav nav-tabs active mt-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#dailySales">COMMISSION EVENT SALES</a>
                    </li>

                    <?php if ($level == 4) { ?>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#summaryCommissionEventManager">COMMISSION EVENT
                                MANAGER</a>
                        </li>
                    <?php } ?>
            ...
            <div class="tab-content">
                <div class="row gx-4">
                    <div class="col-md-12 mt-3">
                        <div class="panel-body tab-pane show active" id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT SUMMARY COMMISSION SALES EVENT: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                        ...
                                        <table id="tableSummary" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">TOTAL SHOW</th>
                                                    <th style="text-align: center;">TOTAL JOIN</th>
                                                    <th style="text-align: center;">AMOUNT</th>
                                                    <th style="text-align: center;">COMMISSION SHOW AND JOIN</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportGuestAdminSummary as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        <td style="text-align: center;"><?= $no++ ?></td>
                                                        <td style="text-align: center;"><?= $row['ADMINNAME'] ?></td>
                                                        <td style="text-align: center;"><?= $row['TOTALFIRSTVISIT'] ?></td>
                                                        <td style="text-align: center;"><?= $row['TOTALUNIT'] ?></td>
                                                        ...
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['COMMISSIONREVENUE'], 0, ',', ',') ?>
                                                        </td>
                        ...
                        <div class="panel-body tab-pane" id="summaryCommissionEventManager">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT SUMMARY COMMISSION EVENT MANAGER: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                <div class="table-wrapper p-4">
                                    <div class="table-responsive">
                                        <table id="tblsummaryCommissionEventManager"
                                            class="table table-striped table-bordered" style="width:100%">
                                            <thead class="bg-thead">
                                                <tr>
                                                    <th style="text-align: center;">NO</th>
                                                    <th style="text-align: center;">EVENT</th>
                                                    <th style="text-align: center;">TOTAL GUEST</th>
                                                    <th style="text-align: center;">TOTAL SHOW</th>
                                                    <th style="text-align: center;">TOTAL JOIN</th>
                                                    <th style="text-align: center;">AMOUNT</th>
                                                    <th style="text-align: center;">COMMISSION MEMBER</th>
                                                    <th style="text-align: center;">COMMISSION REVENUE</th>
                                                </tr>
                                            </thead>
                                            <tfoot>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportGuestAdminSummaryManager as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        <td style="text-align: center;"><?= $no++ ?></td>
                                                        <td style="text-align: center;"><?= $row['NAME'] ?></td>
                                                        <td style="text-align: center;"><?= $row['TOTALGUEST'] ?></td>
                                                        <td style="text-align: center;"><?= $row['TOTALFIRSTVISIT'] ?></td>
                                                        <td style="text-align: center;"><?= $row['TOTALUNIT'] ?></td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['AMOUNT'], 0, ',', ',') ?>
                                                        ...
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['COMMISSIONMEMBER'], 0, ',', ',') ?>
                                                        </td>
                                        ...
                                        <table id="tableDailySales" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">FIRSTVISIT</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportGuestAdmin as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        <td style="text-align: center;"><?= $no++ ?></td>
                                                        ...
                                                        <td style="text-align: center;"><?= $row['SHOWDATE'] ?></td>
                                                        <td style="text-align: center;"><?= $row['PROMOTION'] ?></td>
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['AMOUNT'], 0, ',', ',') ?>
                                                        </td>
                                                        <td style="text-align: center;">
                                                            <?= ($row['ISJOIN'] == 1) ? 'JOIN' : 'SHOW' ?>
                                                        </td>
            ...
            <!-- <h3 class="card-header card-header-info d-flex justify-content-between align-items-center" style="font-weight: bold; color: #666666;">
                LAMPIRAN INTERNAL MEMO KOMISI MARKETING
                <a href="<?= base_url('uploads/memo/IM_MARKETING.pdf') ?>" target="_blank"
                    class="btn btn-sm btn-primary float-right">
                    <i class="fa fa-file-pdf-o"></i> Preview PDF
                </a>
            </h3> -->
        </div>
    </div>
    ...
    $(document).ready(function () {
        var table = $('#tableDailySales').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                var sumCol11Filtered12 = display.map(el => data[el][7]).reduce((a, b) => intVal(a) + intVal(b), 0);
        ...
        $('#filterAdmin, #filterBranch').select2({
        ...
        $('#filterAdmin').on('change', function () {
            ...
            table.column(3).search(values, true, false).draw(); // Kolom ke-3 (Admin)
        });

        // Filter berdasarkan Cabang
        $('#filterBranch').on('change', function () {
            var valuesss = $(this).val().join('|');
            table.column(8).search(valuesss, true, false).draw(); // Kolom ke-8 (Branch)
        });
        ...
        $('#tableSummary').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                var sumCol11Filtered11 = display.map(el => data[el][2]).reduce((a, b) => intVal(a) + intVal(b), 0);
                ...
                var sumCol11Filtered14 = display.map(el => data[el][5]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11Filtered15 = display.map(el => data[el][6]).reduce((a, b) => intVal(a) + intVal(b), 0);
                ...
                $(api.column(6).footer()).html(
                    numberFormat(sumCol11Filtered15,)
                );
            },
            "drawCallback": function (settings) {
                var api = this.api();
        ...
        $('#tblsummaryCommissionEventManager').DataTable({
            "pageLength": 100,
            "lengthMenu": [5, 10, 15, 20, 25, 100],
            select: true,
            'bAutoWidth': false,
            "footerCallback": function (row, data, start, end, display) {
                ...
                var sumCol11Filtered14 = display.map(el => data[el][5]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11Filtered15 = display.map(el => data[el][6]).reduce((a, b) => intVal(a) + intVal(b), 0);
                var sumCol11Filtered16 = display.map(el => data[el][7]).reduce((a, b) => intVal(a) + intVal(b), 0);
                ...
                $(api.column(7).footer()).html(
                    numberFormat(sumCol11Filtered16,)
                );
            },
            "drawCallback": function (settings) {
                var api = this.api();
