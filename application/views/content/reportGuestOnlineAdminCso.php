    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-9">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportGuestOnlineAdmin') ?>">
                                        ...
                                        <table id="tableSummary" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">TOTAL FIRST VISIT</th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($reportGuestOnlineAdminCsoSummary as $row) {
                                                    ...
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: right;">
                                                            <?= number_format($row['COMMISSION'], 0, ',', ',') ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
