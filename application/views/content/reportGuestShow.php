    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-9">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportGuestShow') ?>">
            ...
            <div>
                <ul class="nav nav-tabs active mt-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#dailySales">SUMMARY</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#topSpender">TOP SPENDER</a>
                    </li>
                ...
                <div class="row gx-4">
                    <div class="col-md-12 mt-3">
                        <div class="panel-body tab-pane show active" id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT SUMMARY GUEST FIRST VISIT/SHOW: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                        ...
                                        <table id="tableSummary" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">TOTAL GUEST/REGISTER</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportGuestShowSummary as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;"><?= $row['TOTALSHOW'] ?></td>
                                                        <td style="text-align: center;"><?= $row['TOTALJOIN'] ?></td>
                        ...
                        <div class="panel-body tab-pane" id="hwDokter">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT GUEST SHOW JOIN: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>

                                <div class="row p-4 filter-container">
                                    <label for="filterAdmin">Employee:</label>
                                    <select id="filterAdmin" multiple="multiple">
                                        <option value="">ALL</option>
                                        <?php foreach ($employee as $employee) { ?>
                                            <option value="<?= htmlspecialchars($employee['name']) ?>">
                                    ...
                                    <label for="filterPromotion">Promotion:</label>
                                    ...
                                    <select id="filterStatus" multiple="multiple">
                                        ...
                                        <option value="SHOW AND JOIN">Show & Join</option>
                                    ...
                                    <div class="table-responsive">
                                        <table id="tableDailySales" class="table table-striped table-bordered"
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportGuestShow as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        <td style="text-align: center;"><?= $no++ ?></td>
                        ...
                        <div class="panel-body tab-pane" id="topSpender">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    TOP SPENDER: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                <div class="table-wrapper p-4">
                                    <div class="table-responsive">
                                        <table id="tabletopSpender" class="table table-striped table-bordered"
                                            style="width:100%">
                                            <thead class="bg-thead">
                                                <tr>
                                                    <th style="text-align: center;">NO</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportTopSpender as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        <td style="text-align: center;"><?= $no++ ?></td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#filterAdmin, #filterBranch, #filterStatus').select2({
        ...
        $('#filterBranch').on('change', function () {
            ...
            table.column(9).search(valuesss, true, false).draw(); // Kolom ke-8 (Branch)
        });
        ...
        $('#filterStatus').on('change', function () {
            var selected = $(this).val(); // Ambil array nilai yang dipilih

            if (selected && selected.length > 0) {
                // Buat regex: contoh -> ^(AKTIF|NONAKTIF)$
                var regex = '^(' + selected.map(val => $.trim(val)).join('|') + ')$';
                table.column(8).search(regex, true, false).draw();
            } else {
                // Kosongkan filter jika tidak ada pilihan
        ...
        $('#tabletopSpender').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                var sumCol11Filtered12 = display.map(el => data[el][4]).reduce((a, b) => intVal(a) + intVal(b), 0);
