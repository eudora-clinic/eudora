    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-6">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportKPIBeautyConsultant') ?>">
                                        ...
                                        <table id="tableDailySales" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">PERCENTAGE OMSET</th>
                                                    <th style="text-align: center;">PERCENTAGE UNIT</th>
                                                </tr>
                                            </thead>
                                            <tfoot>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($summaryRevenueBySales as $row) {
                                                    if ($row['JOBID'] != 4 || $row['TOTAL'] == 0 || $row['LOCATIONID'] == 24 || $row['LOCATIONID'] == 25)
                                                        continue;
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;">
                                                            <?= number_format($row['TARGETOMSET'], 0, '.', ',') ?></td>
                                                        <td style="text-align: center;"><?= $row['TARGETUNIT'] ?></td>
                                                        <td style="text-align: center;"><?= $row['TOTALUNIT'] ?></td>
                                                        <td style="text-align: center;"><?= number_format($row['PERCENTAGEOMSET'], 2, '.', '') ?></td>
                                                        <td style="text-align: center;"><?= $row['PERCENTAGEUNIT'] ?></td>
