...
<head>
    ...
    <title>Eudora - Report Guest Online Admin Not Show</title>
    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-9">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportNewGuestNoAppointment') ?>">
                        ...
                        <div class=" " id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT GUEST NOT SHOW: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                    ...
                                    <div class="table-responsive">
                                        <table id="tableDailySales" class="table table-striped table-bordered" style="width:100%">
                                            <thead class="bg-thead">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">BRANCH</th>
                                                     <th style="text-align: center;">REG BOOK DATE</th>
                                                    <th style="text-align: center;">REQ BOOK TIME</th>
                                                    <th style="text-align: center;">REQ TREATMENT</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($reportNewGuestNoAppointment as $row) {
                                                ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;"><?= $row['BOOKDATEREQ'] ?></td>
                                                        <td style="text-align: center;"><?= $row['BOOKTIMEREQ'] ?></td>
                                                        <td style="text-align: center;"><?= $row['TREATMENTREQ'] ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
