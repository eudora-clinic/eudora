...
<head>
    ...
    <title>Eudora - Report Prescription Dokter</title>
    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-6">
                <form id="form-cari-invoice" method="post" action="<?= base_url('reportPrescriptionDoctor') ?>">
                    <div class="row g-3">
                        <div class="col-md-4">
                ...
                <div class="row gx-4">
                    <div class="col-md-12 mt-3">
                        <div class="panel-body tab-pane show active" id="hwTherapist">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT SUMMARY PRESCRIPTION: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                    ...
                                    <div class="table-responsive">
                                        <table id="tableHwTherapist" class="table table-striped table-bordered"
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($listPrescriptionDoctorSummary as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        <td style="text-align: center;"><?= $no++ ?></td>
                                                        <td style="text-align: center;"><?= $row['LOCATIONNAME'] ?></td>
                                                        <td style="text-align: center;"><?= $row['DOCTERNAME'] ?></td>
                        ...
                        <div class="panel-body tab-pane" id="hwDokter">
                            <div class="card">
                                <h3 class="card-header card-header-info" style="font-weight: bold; color: #666666;">
                                    REPORT DETAIL PRESCRIPTION DOKTER: <?= $dateStart ?> - <?= $dateEnd ?>
                                </h3>
                                <div class="table-wrapper p-4">
                                    <div class="table-responsive">
                                        <table id="tableDailySales" class="table table-striped table-bordered"
                                            ...
                                            <thead class="bg-thead">
                                                <tr>
                                                    <th style="text-align: center;">NO</th>
                                                    <th style="text-align: center;">CLINIC</th>
                                                    <th style="text-align: center;">DOCTER</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($listPrescriptionDoctor as $row) {
                                                    ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        <td style="text-align: center;"><?= $no++ ?></td>
                                                        <td style="text-align: center;"><?= $row['LOCATIONNAME'] ?></td>
                                                        ...
                                                        <td style="text-align: center;"><?= $row['MEMBERNAME'] ?></td>
                                                        <td style="text-align: right;">
            ...
            <h3 class="card-header card-header-info d-flex justify-content-between align-items-center"
                ...
                LAMPIRAN INTERNAL MEMO PRESCRIPTION DOKTER
                <a href="<?= base_url('uploads/memo/INMO_PRESCRIPTIONDOKTER.pdf') ?>" target="_blank"
    ...
    $(document).ready(function () {
        $('#tableDailySales').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                var sumCol11Filtered7 = display.map(el => data[el][5]).reduce((a, b) => intVal(a) + intVal(b), 0);
        ...
        $('#tableHwTherapist').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                var sumCol11Filtered8 = display.map(el => data[el][3]).reduce((a, b) => intVal(a) + intVal(b), 0);
