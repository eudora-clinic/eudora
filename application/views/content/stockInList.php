    ...
    <div>
        <div class="mycontaine">
            <div class="card p-2 col-md-9">
                <form id="form-cari-invoice" method="post" action="<?= base_url('stockInList') ?>">
                        ...
                        <div class=" " id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info d-flex justify-content-between align-items-center"
                                    ...
                                    STOCK IN LIST: <?= $dateStart ?> - <?= $dateEnd ?>
                                    <a href="https://sys.eudoraclinic.com:84/app/stockIn"
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($stockInList as $row) {
                                                    ...
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;"><?= $row['STOCKINDATE'] ?></td>
                                                        ...
                                                        <td style="text-align: center;"><?= $row['LOCNAME'] ?> /
                                                            <?= $row['WHNAME'] ?>
                                                        </td>
                                                        <td style="text-align: center;"><?= $row['SUPPLIERNAME'] ?></td>
                                                        <td style="text-align: center;"><?= $row['STATUS'] ?></td>
                                                        <td style="text-align: center;">
                                                            <!-- <a href="https://sys.eudoraclinic.com:84/app/stockIn" class="btn btn-primary btn-sm">
...
<script>
            ...
            buttons: [
                {
                    ...
                    exportOptions: {
                        columns: [0, 1, 2, 4, 5, 6, 7, 8] // ganti dengan indeks kolom yang mau masuk PDF
                    }
                }
            ]
        });
    ...
    function goToDetail(id) {
        console.log(id);
        let base_url = "<?= base_url('stockInDetail'); ?>";
