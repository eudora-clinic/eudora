    	...
    	<div class="col-md-12">
      		<div class="card">
        		<div class="card-header card-header-danger">
            		<h4 class="card-title">Summary Repeat Order</h4>
        		</div>
				<div class="card-body">
					<div class="toolbar">
					</div>
					<div>
						<?php
							...
							# query
							$query = $db_oriskin->query("EXEC spReportSummaryDetailOrder '2023-06', '32' ");
							if ($query->num_rows() <= 0) {
						...
						<table id="example" class="table table-bordered" style="width:100%">
									<thead class="thead-danger">
										<tr role="">
										<th width="170px" class="text-center">RSM</th>
										<th width="170px" class="text-center">Pengelola</th>
											<th width="100px" class="first-col sticky-col">Location Name</th>
											<th width="50px" class="text-center" >Total RO</th>
											...
											<th width="100px" class="text-center" >Amount Donedeal</th>
											<th width="50px" class="text-center">Total Show</th>
											<th width="50px" class="text-center">Show (%)</th>
											<th width="50px" class="text-center">Total RO</th>
											<th width="50px" class="text-center">RO (%)</th>
											<th width="80px" class="text-center">Amount</th>
											<th width="50px" class="text-center">Total NO RO</th>
											<th width="50px" class="text-center">NO RO (%)</th>
									...
									<tbody>
										<?php
											if (isset($header)) {
												...
												<td class="text-center">'.$v['TOTALREPEATORDER'].'</td>
												...
												<td class="text-center">'.$v['PRECENTAGESHOW'].'</td>
												<td class="text-center">'.$v['TOTALRO'].'</td>
												<td class="text-center">'.$v['PRECENTAGERO'].'</td>
												<td class="text-center">'.number_format($v['AMOUNT'], 0, ',', '.').'</td>
												<td class="text-center">'.$v['TOTALNORO'].'</td>
												<td class="text-center">'.$v['PRECENTAGENORO'].'</td>
									...
									$(document).ready(function () {
										...
										"footerCallback": function ( row, data, start, end, display ) {
											...
											$( api.column( 4 ).footer() ).html(
												...
												numberFormat((sumCol11Filtered4/sumCol11Filtered3)*100, 2, ',', '.')
											);
											$( api.column( 6 ).footer() ).html(
												numberFormat(sumCol11Filtered6, 0, ',', '.')
											);
												$( api.column( 7 ).footer() ).html(
												numberFormat((sumCol11Filtered6/sumCol11Filtered3)*100, 2, ',', '.')
											);
											...
											$( api.column( 9 ).footer() ).html(
												...
												numberFormat((sumCol11Filtered9/sumCol11Filtered3)*100, 2, ',', '.')
											);
											$( api.column( 11 ).footer() ).html(
												numberFormat(sumCol11Filtered11, 0, ',', '.')
											);
											$( api.column( 12 ).footer() ).html(
												numberFormat((sumCol11Filtered11/sumCol11Filtered3)*100, 2, ',', '.')
											);
											...
											$( api.column( 15 ).footer() ).html(
												numberFormat((sumCol11Filtered14/sumCol11Filtered3)*100, 2, ',', '.')
											);
										},
										...
										buttons: [
											...
											{ 
												extend: 'pdfHtml5',
												title: 'Summary Follow-Up Repeat Order',
											...
											{ extend: 'excelHtml5',title: 'Summary Follow-Up Repeat Order', footer: true },
