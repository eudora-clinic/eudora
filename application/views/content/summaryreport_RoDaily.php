    	...
    	<div class="col-md-12">
      		<div class="card">
        		<div class="card-header card-header-danger">
            		<h4 class="card-title">Report Daily RO</h4>
        		</div>
				<div class="card-body">
				<div class="toolbar">
					...
					<div>
						<?php
							...
							# query
							$query = $db_oriskin->query("EXEC spReportSummaryDetailOrderRangeDaily '".$datestart."','".$dateend."', '32' ");
						...
						<table id="example" class="table table-bordered" style="width:100%">
									<thead class="thead-danger">
										<tr role="">
											<th width="100px" class="text-center">RSM</th>
											<th width="100px" class="text-center">Pengelola</th>
											<th width="150px" class="first-col sticky-col">Clinic</th>
											<th width="70px" class="text-center">Total Call</th>
											<th width="70px" class="text-center">TARGET Call</th>
											<th width="70px" class="text-center">Call-%</th>
											<th width="70px" class="text-center">Total Appt</th>
											<th width="70px" class="text-center">TARGET Appt</th>
											<th width="70px" class="text-center">Appt-%</th>
											<th width="170px" class="text-center">AMOUNT DONEDEAL</th>
											<th width="70px" class="text-center">Total Show</th>
											<th width="70px" class="text-center">TARGET Show</th>
											<th width="70px" class="text-center">Show-%</th>
											<th width="70px" class="text-center">Total RO</th>
											<th width="70px" class="text-center">TARGET RO</th>
											<th width="70px" class="text-center">RO-%</th>
											<th width="100px" class="text-center">Amount</th>
											<th width="50px" class="text-center">Total Not RO</th>
									...
									<tbody>
										<?php
											if (isset($header)) {
												...
												<td class="text-center">'.$v['TARGETCALL'].'</td>
												<td class="text-center">'.$v['CALLPERCENT'].'</td>
												<td class="text-center">'.$v['TOTALAPPT'].'</td>
												<td class="text-center">'.$v['TARGETAPPT'].'</td>
												<td class="text-center">'.$v['APPTPERCENT'].'</td>
												<td class="text-center">'.number_format($v['TOTALAMOUNTDONEDEAL'], 0, ',', '.').'</td>
												<td class="text-center">'.$v['TOTALSHOW'].'</td>
												<td class="text-center">'.$v['TARGETSHOW'].'</td>
												<td class="text-center">'.$v['SHOWPERCENT'].'</td>
												<td class="text-center">'.$v['TOTALRO'].'</td>
												<td class="text-center">'.$v['TARGETRO'].'</td>
												<td class="text-center">'.$v['ROPERCENT'].'</td>
								...
								$(document).ready(function () {
								  ...
								  var dateend_indo = dateend_split[2]+'-'+dateend_split[1]+'-'+dateend_split[0];
									...
									"footerCallback": function ( row, data, start, end, display ) {
										...
										var sumCol11Filtered13 = display.map(el => data[el][13]).reduce((a, b) => intVal(a) + intVal(b), 0 );
										var sumCol11Filtered14 = display.map(el => data[el][14]).reduce((a, b) => intVal(a) + intVal(b), 0 );
										var sumCol11Filtered16 = display.map(el => data[el][16]).reduce((a, b) => intVal(a) + intVal(b), 0 );
										var sumCol11Filtered17 = display.map(el => data[el][17]).reduce((a, b) => intVal(a) + intVal(b), 0 );
										...
										$( api.column( 5 ).footer() ).html(
												numberFormat((sumCol11Filtered3/sumCol11Filtered4)*100, 2, ',', '.')
											);	
										...
										$( api.column( 8 ).footer() ).html(
												numberFormat((sumCol11Filtered6/sumCol11Filtered7)*100, 2, ',', '.')
											);		
										...
										$( api.column( 12 ).footer() ).html(
												numberFormat((sumCol11Filtered10/sumCol11Filtered11)*100, 2, ',', '.')
											);
										$( api.column( 13 ).footer() ).html(
											numberFormat(sumCol11Filtered13, 0, ',', '.')
										);
										$( api.column( 14 ).footer() ).html(
											numberFormat(sumCol11Filtered14, 0, ',', '.')
										);
										
										$( api.column( 15 ).footer() ).html(
												numberFormat((sumCol11Filtered13/sumCol11Filtered14)*100, 2, ',', '.')
											);
									...
									buttons: [
										...
										{ 
											extend: 'pdfHtml5',
											title: 'Report Call Daily Repeat Order\n Period: '+datestart_indo+' - '+dateend_indo,
