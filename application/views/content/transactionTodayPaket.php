...
<head>
    ...
    <title>Eudora - Transaction Membership Today</title>
...
$locationIdFromUserdata = $this->session->userdata('locationid');
    ...
    $listTransactionTreatment = $db_oriskin->query("SELECT 
                                a.customerid as CUSTOMERID,a.id as ID, a.invoiceno as INVOICENO , CAST(a.invoicedate AS DATE) AS INVOICEDATE , c.firstname as FIRSTNAME , b.totalamount as TOTAL, d.name  as DIINPUT, e.name as SALES, f.name as TREATMENT
                                ...
                                inner join msproductmembershiphdr f on b.productmembershiphdrid = f.id
                                where a.locationsalesid = $locationId  and CONVERT(varchar(10), a.invoicedate, 120)  between '" . $dateStart  . "' and '" . $dateEnd  . "'  and status <> 3")->result_array();

    $listTransactionDownPaymentTreatment = $db_oriskin->query("SELECT 
                                a.customerid as CUSTOMERID, a.id as ID, a.downpaymentno as INVOICENO , CAST(a.downpaymentdate AS DATE) AS INVOICEDATE , c.firstname as FIRSTNAME , b.totalamount as TOTAL, d.name  as DIINPUT, e.name as SALES, f.name as TREATMENT
                                ...
                                inner join msemployee e on a.salesid = e.id
                                inner join msproductmembershiphdr f on b.productmembershiphdrid = f.id
                                where a.locationsalesid = $locationId  and CONVERT(varchar(10), a.downpaymentdate, 120) between  '" . $dateStart  . "' and '" . $dateEnd  . "' and status <> 3")->result_array();
    ?>
</head>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control text-uppercase" name="dateStart" id="dateStart" value="<?= $dateStart ?>" placeholder="DATE SEARCH" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                ...
                <div class="row gx-4">
                    <div class="col-md-12 mt-3">
                        <div class="panel-body tab-pane show active" id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info" style=" font-weight: bold; color: #666666;">
                                    TRANSACTION PAKET TODAY: <?= $dateStart ?>
                                </h3>
                                                ...
                                                ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;">
                                                            <a class="btn btn-primary btn-sm" href="https://sys.eudoraclinic.com:84/app/printinvoice/3/<?= $row['ID'] ?>">print</a>
                                                            ...
                                                            <?php if ($level == 3 || $level == 4) { ?>
                                                                <button class="btn btn-primary btn-sm void-btn" data-id="<?= $row['ID'] ?>" data-rev="3">void</button>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                        ...
                        <div class="panel-body tab-pane" id="detailPayment">
                            <div class="card">
                                <h3 class="card-header card-header-info" style=" font-weight: bold; color: #666666;">
                                    TRANSACTION DOWNPAYMENT PACKAGE TODAY : <?= $dateStart ?>
                                    </h4>
                                    <div class="table-wrapper p-4">
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr role="" style="font-weight: 400;">
                                                            ...
                                                            <td style="text-align: center;"><?= $row['SALES'] ?></td>
                                                            <td style="text-align: center;">
                                                                <a class="btn btn-primary btn-sm" href="https://sys.eudoraclinic.com:84/app/printinvoice/4/<?= $row['ID'] ?>">print</a>
                                                                ...
                                                                <?php if ($level == 3 || $level == 4) { ?>
                                                                    <button class="btn btn-primary btn-sm void-btn" data-id="<?= $row['ID'] ?>" data-rev="4">void</button>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
