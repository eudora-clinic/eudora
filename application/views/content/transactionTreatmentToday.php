...
<head>
    ...
    <title>Eudora - Transaction Treatment Today</title>
    ...
    $listTransactionTreatment = $db_oriskin->query("SELECT 
                                ...
                                inner join mstreatment f on b.productid = f.id
    ...
    $listTransactionDownPaymentTreatment = $db_oriskin->query("SELECT 
                                a.id as ID, a.downpaymentno as INVOICENO , a.downpaymentdate as INVOICEDATE , c.firstname as FIRSTNAME , b.total as TOTAL, d.name  as DIINPUT, e.name as SALES, f.name as TREATMENT
                ...
                <div class="row gx-4">
                    <div class="col-md-12 mt-3">
                        <div class="panel-body tab-pane show active" id="dailySales">
                            <div class="card">
                                <h3 class="card-header card-header-info" style=" font-weight: bold; color: #666666;">
                                    TRANSACTION TREATMENT TODAY: <?= $dateSearch ?> - <?= $dateEnd ?>
                                </h3>
                                                ...
                                                ?>
                                                    <tr role="" style="font-weight: 400;">
                                                        ...
                                                        <td style="text-align: center;">
                                                            <a class="btn btn-primary btn-sm" href="https://sys.eudoraclinic.com:84/app/printinvoice/1/<?= $row['ID'] ?>">print</a>
                                                            ...
                                                            <?php if ($level == 3 || $level == 4) { ?>
                                                                <button class="btn btn-primary btn-sm void-btn" data-id="<?= $row['ID'] ?>" data-rev="1">void</button>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                        ...
                        <div class="panel-body tab-pane" id="detailPayment">
                            <div class="card">
                                <h3 class="card-header card-header-info" style=" font-weight: bold; color: #666666;">
                                    TRANSACTION DETAIL PAYMENT TREATMENT TODAY : <?= $dateSearch ?>
                                    </h4>
                                    <div class="table-wrapper p-4">
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr role="" style="font-weight: 400;">
                                                            ...
                                                            <td style="text-align: center;"><?= $row['SALES'] ?></td>
                                                            <td style="text-align: center;">
                                                                <a class="btn btn-primary btn-sm" href="https://sys.eudoraclinic.com:84/app/printinvoice/2/<?= $row['ID'] ?>">print</a>
                                                                <?php if ($level == 3 || $level == 4) { ?>
                                                                    <button class="btn btn-primary btn-sm void-btn" data-id="<?= $row['ID'] ?>" data-rev="2">void</button>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
